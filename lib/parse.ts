...
/** The `dir` field returned by `path.posix.parse`, which is empty for a path with no directory portion. */
export type PluckParsedDirname<T extends string> = PluckDirname<T> extends "." ? "" : PluckDirname<T>
...
export interface ParsedPath<T extends string> {
	/**
	 * The POSIX root of the path, when present.
	 */
	root: PathRoot<T>
	/**
	 * The full directory path such as '/home/user/dir', or an empty string when none is present.
	 */
	dir: PluckParsedDirname<T>
	/**
